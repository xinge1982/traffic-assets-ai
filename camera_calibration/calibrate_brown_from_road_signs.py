...
def main():
    ...
    prior = base.copy()
    lo = np.asarray([300, 300, w / 2 - 300, h / 2 - 300, -1, -1, -.1, -.1, -1, -args.yaw_limit, -25, -15, -5, -3, -3],
                    float)
    hi = np.asarray([6000, 6000, w / 2 + 300, h / 2 + 300, 1, 1, .1, .1, 1, args.yaw_limit, 25, 15, 5, 3, 3], float)
